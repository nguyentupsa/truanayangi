...
export const copy = {
  vi: {
    ...
    vegetarianOnly: 'Chỉ ăn chay', vegetarian: 'Ăn chay', nonVegetarian: 'Ăn mặn', dietAll: 'Tất cả', dietFilter: 'Loại món', opening: 'ĐANG MỞ HÒM…', openAgain: 'MỞ LẠI', open: 'MỞ HÒM',
    newItem: 'VẬT PHẨM MỚI', referencePrice: 'Giá tham khảo', perPerson: '/ người', find: 'TÌM QUÁN', continue: 'TIẾP TỤC', nearby: 'quán bình dân Thảo Điền An Khánh Quận 2',
  ...
  en: {
    ...
    vegetarianOnly: 'Vegetarian only', vegetarian: 'Vegetarian', nonVegetarian: 'Non-vegetarian', dietAll: 'All', dietFilter: 'Diet filter', opening: 'OPENING CASE…', openAgain: 'OPEN AGAIN', open: 'OPEN CASE',
    newItem: 'NEW ITEM', referencePrice: 'Typical price', perPerson: '/ person', find: 'FIND NEARBY', continue: 'CONTINUE', nearby: 'casual eatery Thao Dien District 2 HCMC',

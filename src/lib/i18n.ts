...
export const copy = {
  vi: {
    ...
    newItem: 'VẬT PHẨM MỚI', referencePrice: 'Giá tham khảo', perPerson: '/ người', find: 'TÌM QUÁN', continue: 'TIẾP TỤC', nearby: 'Thảo Điền An Khánh Quận 2',
  ...
  en: {
    ...
    newItem: 'NEW ITEM', referencePrice: 'Typical price', perPerson: '/ person', find: 'FIND NEARBY', continue: 'CONTINUE', nearby: 'Thao Dien District 2 HCMC',
...
const englishNames: Record<number, string> = {
  ...
  135:'Jollibee Chickenjoy',136:'Jolly Spaghetti',137:'Jollibee chicken burger',138:'Jollibee chicken rice',
};
